...
function getCategoryAndAxisStringsFromChildren(props, axis, childComponents) {
  ...
  return (0, _uniq2.default)([].concat(_toConsumableArray(categoryStrings), _toConsumableArray(axisStrings)).flat());
}
...
function getStringsFromChildren(props, childComponents) {
  ...
  return {
    x: (0, _uniq2.default)([].concat(_toConsumableArray(xStrings), _toConsumableArray(dataStrings.x)).flat()),
    y: (0, _uniq2.default)([].concat(_toConsumableArray(yStrings), _toConsumableArray(dataStrings.y)).flat())
  };
}
