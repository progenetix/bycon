...
getScopedEvents) {
  ...
  var ownEvents = allEvents && (0, _helpers.isFunction)(getScopedEvents) ? getScopedEvents(getEventsByTarget(allEvents), target) : undefined;
...
function getScopedEvents(events, namespace, childType, baseProps) {
  ...
  var compileCallbacks = function (eventReturn) {
    var getCallback = function (obj) {
      return (0, _helpers.isFunction)(obj.callback) && obj.callback;
    };
...
function getExternalMutation(mutations, baseProps, baseState, identifier) {
  ...
  return keyMutations.reduce(function (memo, curr) {
    var mutationFunction = curr && (0, _helpers.isFunction)(curr.mutation) ? curr.mutation : function () {
      return undefined;
    };
...
function getComponentEvents(props, components) {
  var events = Array.isArray(components) && components.reduce(function (memo, componentName) {
    ...
    var componentEvents = (0, _helpers.isFunction)(defaultEvents) ? defaultEvents(component.props) : defaultEvents;
