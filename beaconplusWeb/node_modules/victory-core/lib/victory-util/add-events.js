  ...
  var AddEventsMixin = /*#__PURE__*/function (_WrappedComponent) {
    ...
    _createClass(AddEventsMixin, [{
      ...
      value: function applyExternalMutations(props, externalMutations) {
        if (!(0, _isEmpty2.default)(externalMutations)) {
          var callbacks = props.externalEventMutations.reduce(function (memo, mutation) {
            return (0, _helpers.isFunction)(mutation.callback) ? memo.concat(mutation.callback) : memo;
          }, []);
      ...
      value: function getCalculatedValues(props) {
        ...
        var getSharedEventState = sharedEvents && (0, _helpers.isFunction)(sharedEvents.getEventState) ? sharedEvents.getEventState : function () {
          return undefined;
        };
