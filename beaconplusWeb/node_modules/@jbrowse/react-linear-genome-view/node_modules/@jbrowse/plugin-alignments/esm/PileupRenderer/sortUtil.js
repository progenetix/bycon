...
export const sortFeature = (features, sortedBy) => {
    ...
    switch (type) {
        ...
        case 'tag': {
            ...
            const isString = featuresInCenterLine[0] &&
                typeof getTag(featuresInCenterLine[0], tag) === 'string';
            if (isString) {
                featuresInCenterLine.sort((a, b) => getTag(b, tag).localeCompare(getTag(a, tag)));
            }
            else {
                featuresInCenterLine.sort((a, b) => (getTag(b, tag) || 0) - (getTag(a, tag) || 0));
            }
            break;
        }
