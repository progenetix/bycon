import { types, getParent, isAlive, cast, getSnapshot, } from 'mobx-state-tree';
import { readConfObject } from '@jbrowse/core/configuration';
import { assembleLocString, getSession, getContainingDisplay, getContainingView, getViewParams, makeAbortableReaction, } from '@jbrowse/core/util';
import { Region } from '@jbrowse/core/util/types/mst';
import { isRetryException, } from '@jbrowse/core/util/types';
import { getTrackAssemblyNames, getRpcSessionId, } from '@jbrowse/core/util/tracks';
// locals
...
const blockState = types
    ...
    return {
        ...
        afterAttach() {
            ...
            setTimeout(() => {
                if (isAlive(self)) {
                    makeAbortableReaction(self, renderBlockData, renderBlockEffect, // reaction doesn't expect async here
                    {
