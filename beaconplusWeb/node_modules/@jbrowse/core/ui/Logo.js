...
exports.LogoFull = exports.Logomark = void 0;
...
function Text({ variant }) {
    const colors = getColors(variant);
    return (react_1.default.createElement("g", { "aria-label": "JBrowse", transform: "translate(213.084 144.241)", style: { fill: colors.midnight } },
