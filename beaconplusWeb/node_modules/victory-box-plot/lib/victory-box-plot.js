...
var VictoryBoxPlotBase = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(VictoryBoxPlotBase, [{
    ...
    value: function shouldRenderDatum(datum) {
      var hasX = !_victoryCore.Helpers.isNil(datum._x);
      var hasY = !_victoryCore.Helpers.isNil(datum._y);
      var hasSummaryStatistics = !_victoryCore.Helpers.isNil(datum._min) && !_victoryCore.Helpers.isNil(datum._max) && !_victoryCore.Helpers.isNil(datum._median) && !_victoryCore.Helpers.isNil(datum._q1) && !_victoryCore.Helpers.isNil(datum._q3);
