...
var VictoryTooltip = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(VictoryTooltip, [{
    ...
    value: function getStyles(props) {
      ...
      var flyoutStyle = _victoryCore.Helpers.evaluateStyle(baseFlyoutStyle, Object.assign({}, props, {
        style: style
      }));
    ...
    value: function getEvaluatedProps(props) {
      ...
      var text = _victoryCore.Helpers.evaluateProp(props.text, Object.assign({}, props, {
        active: active
      }));
      ...
      var orientation = _victoryCore.Helpers.evaluateProp(props.orientation, Object.assign({}, props, {
        active: active,
        text: text,
        style: style,
        flyoutStyle: flyoutStyle
      })) || this.getDefaultOrientation(props);
      var padding = _victoryCore.Helpers.evaluateProp(props.flyoutPadding, Object.assign({}, props, {
        active: active,
        text: text,
        style: style,
        flyoutStyle: flyoutStyle,
      ...
      var pointerWidth = _victoryCore.Helpers.evaluateProp(props.pointerWidth, Object.assign({}, props, {
        active: active,
        text: text,
        style: style,
        flyoutStyle: flyoutStyle,
      ...
      var pointerLength = _victoryCore.Helpers.evaluateProp(props.pointerLength, Object.assign({}, props, {
        active: active,
        text: text,
        style: style,
        flyoutStyle: flyoutStyle,
