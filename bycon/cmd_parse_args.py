...
def get_cmd_args():
    ...
    try:
        opts, args = getopt.getopt(argv, "htd:b:e:j:a:f:y:c:o:g:", [ "help", "dataset_id=" "bioclass=", "extid=", "jsonqueries=", "dotalpha=", "mappingfile=", "icdomappath=", "cytoband=", "chroBases=", "genome=" ] )
